...
public class DemoAdapter extends RecyclerView.Adapter<DemoAdapter.BaseViewHolder> {
    ...
    private class OneViewHolder extends BaseViewHolder {
        ...
        public OneViewHolder(View view) {
            super(view);
            btn = (TextView) view.findViewById(R.id.tv);
        ...
        void setData(Object data) {
            if (data != null) {
                ...
                if (getAdapterPosition() == lastPressIndex) {
                    ...
                    btn.setTextColor(ContextCompat.getColor(itemView.getContext(), R.color.white));
                    btn.setEnabled(false);

                } else {
                    btn.setSelected(false);
                    btn.setTextColor(ContextCompat.getColor(itemView.getContext(), R.color.black_3));
                    btn.setEnabled(true);
                }
            }
        }
