...
public class Lockbike extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MainActivity.getIsreturn()==0){
            mynumber.setText("用车编号：" + String.valueOf(Integer.parseInt(MainActivity.getNumber())));

        }else {
            mynumber.setText("用车编号：" + currentborrow.getBicycleId());
            bicycleId=currentborrow.getBicycleId();
        }
        ...
        over_bike.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                MainActivity.setIsreturn(0);
                DialogActivity.setIsborrow(0);
                ...
                intentor.putExtra("returned",DialogActivity.getIsborrow());
                intentor.setAction("com.wofi.Lock.Lockbike");
                sendBroadcast(intentor);
